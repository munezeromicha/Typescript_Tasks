...
//This comes from index.d.ts

declare module 'str-utils' {
    type StringMan = (input: string) => string;

    export const strReverse: StringMan;
    export const strToLower: StringMan;
    export const strToUpper: StringMan;
    export const strRandomize: StringMan;
    export const strInvertCase: StringMan;
}
